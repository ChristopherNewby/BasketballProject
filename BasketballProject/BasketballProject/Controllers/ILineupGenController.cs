...
namespace BasketballProject.Controllers
{
    public class ILineupGenController : Controller
    {
        ...
        public ActionResult GenerateTeamWithoutInjuries()
        {
            ILineupGenModel Glineup = new ILineupGenModel();
            ...
            Glineup.Player9 = C.OrderByDescending(item => item.Salary).First();
             ...
             IUtils.FixITeamSInj(ref Glineup); 
                       
            return View(Glineup);
        }

        public ActionResult GenerateTeamWithoutOuts()
        {
            ILineupGenModel Glineup = new ILineupGenModel();
            ...
            IUtils.FixITeamSO(ref Glineup);

            return View(Glineup);
        }

        public ActionResult GenerateTeamByFFPG()
        {
            ILineupGenModel Glineup = new ILineupGenModel();
            ...
            IUtils.FixITeamFpg(ref Glineup);
